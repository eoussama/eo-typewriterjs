import type { TRichTextDocument, TStyleObject, TStyleRef, TTextStyle } from "../types/rich-text-document.type";
import type { TRichTextSegment } from "../types/rich-text-segment.type";
